#MAIN_DIR<-'Fi_gdsc1000_RESULTS/gdscANOVA/MultiFactorialPANCAN/PANCAN_GDSC1000_paper_set_2015-11-25_14-09-09/'
...
source('Fi_gdsc1000_CODE/gdscANOVA/CELL LINES MULTIFACTOR//gdscANOVA_ind_pack_creation_library.R')
